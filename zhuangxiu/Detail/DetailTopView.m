...
- (void)shareWebPageToPlatformType:(UMSocialPlatformType)platformType
{
    ...
    //创建网页内容对象
    UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:@"盒装" descr:@"" thumImage:self.model.photo_img_s];
    //设置网页地址
    shareObject.webpageUrl = @"https://m.to8to.com/tubatu/decorateStyle.html?ptag=2_1_1_2324";
